...
{
    static const int gpios[APP_BTN_COUNT] = { HW_BTN1_GPIO, HW_BTN2_GPIO, HW_BTN3_GPIO };
    ...
    ESP_LOGI(TAG, "Buttons initialized (GPIO %d, %d, %d)", HW_BTN1_GPIO, HW_BTN2_GPIO, HW_BTN3_GPIO);
    return ESP_OK;
}
